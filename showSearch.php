...
{
    searchInsert($con,$_SESSION['id'],$_GET['searchText'],date("h:i:sa"),$_SERVER['REMOTE_ADDR']);
}
else
{
    searchInsert($con,0,$_GET['searchText'],date("h:i:sa"),$_SERVER['REMOTE_ADDR']);
}


$row = searchCourses($con,$_GET['searchText']);
$res=null;
?>
